...
<div class="container">
	<div class="col-md-4 offset-md-4 shadow bg-dark" style="margin-top:200px;">
			
			<form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" class=" w-100 p-3" method="post">
				<h5 class="text-white text-center mb-2">Login</h5>
				<?php 
				...
				if ($_SERVER['REQUEST_METHOD'] === 'POST') {
					...
					if (isset($_POST['submit'])) {
						...
						$q = "select * from user where (userid = '$login') and password = '$password'";
				...
				<input type="text" class="form-control mb-3 mt-4" name="user_id" placeholder="user_id">
